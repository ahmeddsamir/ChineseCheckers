...
class View {
    ...
    private void createAndShowGUI() {
        JFrame f = new JFrame("Chines Checkers");
    ...
    class TopPanel extends JPanel {
        TopPanel() {
            ...
            add(new JLabel("Chinese Checkers"));
        }
    }
    ...
    class Player extends JLabel{
        ...
        protected void paintComponent(Graphics g) {
            ...
            //g.fillRoundRect(model.getPlayerX(), model.getPlayerY(), model.getPlayerSize(),model.getPlayerSize(), 10, 10);
        }
    }
...
class Model{
    ...
    private int boardRows = 17, boardCols = 25, squareSize = 20;
